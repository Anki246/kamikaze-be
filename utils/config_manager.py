...
from agents.fluxtrader.config import config, ConfigManager
...
class FluxTraderConfigManager:
    ...
    def show_configuration(self):
        ...
        # API Settings
        print("\n🔑 API Settings:")
        print(f"   Binance API Key: {'✅ Set' if config.api.binance_api_key else '❌ Not set'}")
        print(f"   Binance Secret: {'✅ Set' if config.api.binance_secret_key else '❌ Not set'}")
        ...
        # Market Analysis
        print("\n📈 Market Analysis:")
        print(f"   Signal Strength Threshold: {config.market_analysis.signal_strength_threshold}")
    ...
    def reset_configuration(self):
        ...
        confirmation = input("⚠️  This will reset ALL configuration to defaults. Continue? (type 'YES'): ")
        if confirmation != "YES":
