...
class BinanceConnectionService:
        ...
        try:
            ...
            if not account_result['success']:
                ...
                if error_code == -2015:
                    ...
                    detailed_msg = f"Timestamp error: {error_msg}. Please check your system clock."
                elif error_code == -1022:
                    detailed_msg = f"Signature error: {error_msg}. Please check your secret key."
                else:
    ...
    async def validate_api_key_format(self, api_key: str, is_testnet: bool = False) -> Tuple[bool, str]:
    ...
    async def get_account_status(
        ...
        try:
            ...
            status_data = trading_status.get('data', {}) if trading_status['success'] else {}
