...
class ConfigManager:
            ...
            try:
                ...
                if 'risk_management' in json_config:
                    ...
                    if 'trailing_stop_loss' in risk_config:
                        ...
                        self.risk_management.trailing_stop_loss_1 = tsl.get('level_1', 1.5)
                        self.risk_management.trailing_stop_loss_2 = tsl.get('level_2', 2.5)
                        self.risk_management.trailing_stop_loss_3 = tsl.get('level_3', 4.0)

                    if 'trailing_take_profit' in risk_config:
                        ttp = risk_config['trailing_take_profit']
                        self.risk_management.trailing_take_profit_1 = ttp.get('level_1', 2.0)
                        self.risk_management.trailing_take_profit_2 = ttp.get('level_2', 3.5)
                        self.risk_management.trailing_take_profit_3 = ttp.get('level_3', 6.0)
    ...
    def load_from_env(self) -> None:
        ...
        env_mappings = {
            ...
            'SIGNAL_STRENGTH_THRESHOLD': ('trading', 'signal_strength_threshold', float),
            ...
            'TRAILING_TAKE_PROFIT_1': ('risk_management', 'trailing_take_profit_1', float),
            'TRAILING_TAKE_PROFIT_2': ('risk_management', 'trailing_take_profit_2', float),
            'TRAILING_TAKE_PROFIT_3': ('risk_management', 'trailing_take_profit_3', float),
        }
